from MovieLens import MovieLens ## class from movielens.py
...
## fit a KNN baseline algorithm
simsAlgo = KNNBaseline(sim_options=sim_options)
simsAlgo.fit(fullTrainSet)

print("\nBuilding recommendation model...")
trainSet, testSet = train_test_split(data, test_size=.25, random_state=1) ## 25% for testing
